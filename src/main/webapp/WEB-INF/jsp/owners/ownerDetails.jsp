...
<petclinic:layout pageName="owners">
    ...
    <a href="${fn:escapeXml(editUrl)}" class="btn btn-default"><fmt:message key="edit"/></a>
                    ...
                    <table class="table-condensed">
                        ...
                        <c:forEach var="visit" items="${pet.visits}">
                            <tr>
                                ...
                                <td>
                                	<spring:url value="/owners/{ownerId}/pets/{petId}/{visitId}/delete" var="petUrl">
                                    	<spring:param name="ownerId" value="${owner.id}"/>
