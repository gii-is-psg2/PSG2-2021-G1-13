...
<petclinic:layout pageName="itop">
	...
	<div class = "page-body">
		<div class = "title-and-button" id = "vetList-title">
	    	<h2 class = "page-title"><fmt:message key="contact_title"/></h2>
		</div>
	    ...
	    <table id="vetsTable" class="table table-striped">
	        <thead>
	        <tr>
	            <th><fmt:message key="contact_name"/></th>
	            <th><fmt:message key="contact_phone"/></th>
	          	<th><fmt:message key="contact_email"/></th>
